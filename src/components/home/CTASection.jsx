...
export default function CTASection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-[var(--brand-secondary)]/15 blur-3xl" />

      <div className="relative z-10 mx-auto max-w-5xl text-center flex flex-col items-center brand-reveal">
        {/* Mail Icon Circle */}
        <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--brand-secondary)]/10 text-[var(--brand-secondary)] border border-[var(--brand-secondary)]/20 shadow-xs">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Button
            size="lg"
            asChild
            className="primary-btn h-12 px-6 font-bold text-white cursor-pointer"
          >
