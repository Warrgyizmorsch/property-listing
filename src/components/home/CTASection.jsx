...
export default function CTASection() {
  return (
    <section id="contact" className="relative bg-neutral-900 py-20 px-4 dark:bg-zinc-950 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center flex flex-col items-center">
        ...
        {/* Title */}
        <h2 className="font-heading text-3xl font-extrabold tracking-tight text-white sm:text-4xl max-w-2xl leading-[1.2]">
          Ready to Discover Your Next Exclusive Landmark Property?
        </h2>

        {/* Description */}
        <p className="mt-6 max-w-2xl text-base text-neutral-300 leading-7">
          Whether you are looking to purchase a modern luxury villa, lease a premium office tower, or list your private apartment catalog, our certified advisors are here to help.
        </p>

        {/* Actions */}
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Link href="/properties">
            <Button size="lg" className="h-12 bg-white font-bold text-neutral-900 hover:bg-neutral-100 dark:bg-neutral-50 dark:hover:bg-neutral-200">
              Browse Listings
            </Button>
          </Link>
          <Link href="/#contact">
            <Button size="lg" variant="outline" className="h-12 border-neutral-700 bg-transparent font-bold text-white hover:bg-neutral-800">
              Get in Touch
