  ...
  const testimonials = [
    {
      ...
      quote: "LuxeEstates provided an elite level of service. They parsed our exact requirements and secured a stunning penthouse overlooking Manhattan before it hit public indexes.",
      rating: 5,
    },
    {
      name: "Marcus Vance",
      ...
      quote: "The transparency and transaction guidance was refreshing. As a first-time buyer in NY, their certified agents simplified every legal stage with extreme clarity.",
      rating: 5,
    },
    {
      name: "Evelyn Thorne",
      ...
      quote: "Finding high-end commercial office space that matches our strict visual design directives was a challenge. LuxeEstates pinpointed three perfect units within 48 hours.",
      rating: 5,
    },
  ];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-neutral-500 dark:text-neutral-400 text-base leading-6">
            Hear from property buyers, sellers, and luxury investors who reached their property milestones with us.
          </p>
        </div>
