  ...
  const features = [
    {
      ...
      description: "We Hand-select every villa, penthouse, and commercial unit to guarantee premium quality, design standard, and value.",
      icon: <Sparkles className="h-6 w-6 text-indigo-600 dark:text-indigo-400" />,
    },
    {
      title: "Trusted Security",
      description: "Every listing is meticulously verified by our legal experts to safeguard your investment from any unexpected issues.",
      icon: <Shield className="h-6 w-6 text-emerald-600 dark:text-emerald-400" />,
    },
    {
      title: "Professional Agents",
      description: "Our certified real estate agents guide you step-by-step from initial search mapping to contract completion.",
      icon: <Handshake className="h-6 w-6 text-amber-600 dark:text-amber-400" />,
    },
    {
      title: "Personalized Search",
      description: "Dynamic filters, precise geolocation parsing, and instant alerts matching your strict budget brackets.",
      icon: <Search className="h-6 w-6 text-blue-600 dark:text-blue-400" />,
    },
  ];

  return (
    <section id="about" className="bg-white py-20 px-4 dark:bg-zinc-950 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-neutral-500 dark:text-neutral-400 text-base leading-6">
            We provide a transparent, end-to-end purchasing and leasing service crafted for discerning clients seeking excellence.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature, idx) => (
            ...
            >
              ...
              {/* Title */}
              <h3 className="mt-5 text-base font-extrabold text-neutral-950 dark:text-white">
                {feature.title}
              </h3>
