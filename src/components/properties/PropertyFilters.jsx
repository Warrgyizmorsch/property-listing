    ...
    <div className="flex flex-col gap-6 py-1">
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          onChange={(e) => updateQueryParam("purpose", e.target.value)}
          className="h-10 w-full rounded-xl border border-neutral-200/80 bg-white px-3 text-sm font-semibold text-neutral-800 transition-colors focus:border-indigo-500 focus:outline-none dark:border-zinc-800 dark:bg-zinc-900 dark:text-neutral-100 dark:focus:border-indigo-400 cursor-pointer"
        >
      ...
      <div className="grid grid-cols-2 gap-3 border-t border-neutral-100 pt-4 dark:border-neutral-850">
        <div className="space-y-1.5">
          ...
          <select
            ...
            onChange={(e) => updateQueryParam("bedrooms", e.target.value)}
            className="h-9.5 w-full rounded-xl border border-neutral-200/80 bg-white px-2.5 text-xs font-semibold text-neutral-800 focus:border-indigo-500 focus:outline-none dark:border-zinc-800 dark:bg-zinc-900 dark:text-neutral-100 cursor-pointer"
          >
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            onChange={(e) => updateQueryParam("bathrooms", e.target.value)}
            className="h-9.5 w-full rounded-xl border border-neutral-200/80 bg-white px-2.5 text-xs font-semibold text-neutral-800 focus:border-indigo-500 focus:outline-none dark:border-zinc-800 dark:bg-zinc-900 dark:text-neutral-100 cursor-pointer"
          >
            <option value="">Any</option>
      ...
      <div className="space-y-2 border-t border-neutral-100 pt-4 dark:border-neutral-850">
        ...
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            placeholder="Min"
            className="h-9.5 w-full rounded-xl border border-neutral-200/80 bg-white px-3 text-xs font-semibold text-neutral-800 focus:border-indigo-500 focus:outline-none dark:border-zinc-800 dark:bg-zinc-900 dark:text-neutral-100"
          />
          <input
            type="number"
      ...
      <Button
        onClick={handleReset}
        variant="outline"
        className="mt-4 gap-2 w-full font-bold text-neutral-700 hover:text-indigo-600 dark:text-neutral-300 dark:hover:text-indigo-400 border-neutral-200 dark:border-zinc-800"
      >
