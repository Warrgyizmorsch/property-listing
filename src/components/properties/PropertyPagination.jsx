...
export default function PropertyPagination({ page, totalPages }) {
  ...
  return (
    <nav className="mt-12 flex items-center justify-center gap-1.5" aria-label="Pagination">
      ...
      <Button
        ...
        disabled={page === 1}
        className="h-10 w-10 rounded-xl border border-neutral-200 bg-white hover:bg-neutral-50 dark:border-zinc-800 dark:bg-zinc-900"
      >
