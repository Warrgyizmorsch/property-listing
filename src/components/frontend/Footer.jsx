...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-neutral-100 bg-neutral-900 text-neutral-400 dark:border-neutral-800 dark:bg-zinc-950">
      {/* Upper Footer: Grid */}
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-neutral-400 leading-6 max-w-xs">
              Exceptional real estate services to help you find, buy, and list premium properties. Experience the luxury of simplicity.
            </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5 text-sm">
              ...
              <li>
                <Link href="/admin/login" className="hover:text-white transition-colors duration-200">Agent Login</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5 text-sm">
              <li>
                <Link href="/properties?category=apartment" className="hover:text-white transition-colors duration-200">Apartments</Link>
              </li>
              <li>
                <Link href="/properties?category=villa" className="hover:text-white transition-colors duration-200">Villas</Link>
              </li>
              <li>
                <Link href="/properties?category=commercial" className="hover:text-white transition-colors duration-200">Commercial Spaces</Link>
              </li>
              <li>
                <Link href="/properties?category=penthouse" className="hover:text-white transition-colors duration-200">Penthouses</Link>
              </li>
              <li>
                <Link href="/properties?category=land" className="hover:text-white transition-colors duration-200">Lands / Plots</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <span>100 Wall Street, Manhattan,<br />New York, NY 10005</span>
              </li>
      ...
      <div className="border-t border-neutral-800 py-8 dark:border-neutral-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-neutral-500 text-center sm:text-left">
            &copy; {currentYear} LuxeEstates. All rights reserved. Made with love for premium living.
          </p>
