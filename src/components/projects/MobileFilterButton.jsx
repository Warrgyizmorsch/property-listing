    ...
    <div className="lg:hidden">
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetTrigger asChild>
          <Button
            variant="outline"
            className="flex items-center gap-1.5 rounded-xl border-neutral-200 bg-white font-bold text-neutral-700 dark:border-zinc-800 dark:bg-zinc-900 dark:text-neutral-300 cursor-pointer"
          >
        ...
        <SheetContent side="left" className="w-[300px] overflow-y-auto border-r border-neutral-100 bg-white p-6 dark:border-neutral-800 dark:bg-zinc-950">
          ...
          <div className="mt-4">
            ...
            <div onClick={() => setOpen(false)}>
              <ProjectFilters metadata={metadata} />
            </div>
          </div>
        </SheetContent>
      </Sheet>
